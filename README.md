...
The model with the best balanced accuracy score is the Easy Ensemble AdaBoost Classifier with a balanced accuracy score of .93, compared to the Balanced Random Forest Classifier with a balanced accuracy score of .75. The model with the best recall score is the Easy Ensemble AdaBoost Classifier with a average f1 score of .97 compared to the Balanced Random Forest Classifier with an average f1 score of .94. The model with the best Geometric Mean score is the Easy Ensemble AdaBoost Classifier with an average geo score of .93 compared to the Balanced random Forest Classifier with an average geo score of .78. The top three features are total_rec_prncp, total_pymnt_inv, total_pymt.
